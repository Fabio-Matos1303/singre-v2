<template>
  <div class="card" v-if="item">
    <div style="display:flex;justify-content:space-between;align-items:center">
      <h2 style="margin:0">Produto: {{ item.name }}</h2>
      <div style="display:flex;gap:8px">
        <RouterLink class="button" :to="`/products/${item.id}/edit`">Editar</RouterLink>
        ...
        <RouterLink class="button" style="background:#334155" to="/products">Voltar</RouterLink>
      </div>
    </div>
