...
class ServiceController extends Controller
{
     ...
     *   @OA\Parameter(name="sort", in="query", @OA\Schema(type="string", enum={"name","price","created_at"})),
     ...
     *   tags={"Services"},
     *   security={{"bearerAuth":{}}},
     *   @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/Service")),
